...
export class AdminMarketplaceClient {
     ...
     */
    topResourcesRankingAdmin(request = {}, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__topResourcesRankingAdmin(request, requestOptions));
    }
    async __topResourcesRankingAdmin(request = {}, requestOptions) {
        ...
        const _response = await core.fetcher({
            url: core.url.join((await core.Supplier.get(this._options.baseUrl)) ??
                ...
                environments.MktAgiApiEnvironment.Default, "admin/marketplace/top-resources"),
            method: "GET",
            headers: _headers,
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/admin/marketplace/top-resources");
    }
}
