...
export class AdminRevenueClient {
     ...
     */
    marketplaceFeeRevenueSummary(request = {}, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__marketplaceFeeRevenueSummary(request, requestOptions));
    }
    async __marketplaceFeeRevenueSummary(request = {}, requestOptions) {
        ...
        const _response = await core.fetcher({
            url: core.url.join((await core.Supplier.get(this._options.baseUrl)) ??
                ...
                environments.MktAgiApiEnvironment.Default, "admin/revenue/fees"),
            method: "GET",
            headers: _headers,
