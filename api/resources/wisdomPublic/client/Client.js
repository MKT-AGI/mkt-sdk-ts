...
export class WisdomPublicClient {
     ...
     */
    listPublicContents(request = {}, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__listPublicContents(request, requestOptions));
    }
    async __listPublicContents(request = {}, requestOptions) {
        const { username, kind, type: type_, community_id: communityId, community_slug: communitySlug, slug, promise_search: promiseSearch, offset, limit, } = request;
        const _queryParams = {
            username,
            kind,
            type: type_,
        ...
        const _response = await core.fetcher({
            url: core.url.join((await core.Supplier.get(this._options.baseUrl)) ??
                ...
                environments.MktAgiApiEnvironment.Default, "public/wisdom"),
            method: "GET",
            headers: _headers,
